...
<?php
    ...
    if($result=$conn->query($q)){
        ...
        echo "<th colspan='6'>All Books</th>";
        echo "<tr><th>Book ID</th><th>Book Title</th><th>Image</th><th>Price</th><th>Edit</th><th>In Stock</th></tr>";
         while($row=$result->fetch_array()){
             echo "<tr>";
                echo "<td>".$row['cb_id']."</td>";
                echo "<td>".$row['cb_title']."</td>";
                echo "<td>"."<img src=".$row['img']." width='160' height='200'>"."</td>";
                echo "<td>".$row['cb_price']."</td>";
				echo "<td><a href='checkdetail.php?id=".$row[0]."'>","<img src='images/Modify.png' width='24' height='24'>","</a></td>";
				if($row['cb_status']=='2'){
					echo "<td><img src='images/No.png' width='24' height='30'></td>";
				}
				else{
					echo "<td><img src='images/Yes.png' width='24' height='30'></td>";
				}
            echo "</tr>";
        }
        echo "</table>";
