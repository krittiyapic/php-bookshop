...
while($row=$result->fetch_array()){
    ...
    echo "<tr><td><input type=number min=1 max=999 name=cb_qty value=1 style='text-align: center;'></td></tr>";
   
	echo "<input type=hidden name=user value=".$_SESSION['user_id'].">";
  echo "<input type=hidden name=cb_price value=".$row['cb_price'].">";
	echo "<input type=hidden name=cb_id value=".$row['cb_id'].">";
	echo "<input type=hidden name=cb_title value=".$row['cb_title'].">";
...
<a href="shop.php"><img src='images/Back.png' width='30' height='30'></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 <input type="submit" name="add" value="Add to Cart" onclick="return confirm('CONFIRM ?')" id="but">
